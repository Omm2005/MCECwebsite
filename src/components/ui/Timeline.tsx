  ...
  return (
    ...
    >
      <div className='h-auto'>
        ...
        <p className="text-muted-foreground text-sm md:text-base px-10">
          we&apos;ve been working super hard to make the science to life.
        </p>
      </div>

      <div ref={ref} className="relative max-w-7xl md:mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-muted border border-muted/40 p-2" />
              </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full" suppressHydrationWarning>
